...
const projects = [
    { name: "DeFi Protocol A", raise: "$12M", roi: "45x", type: "Incubation" },
    { name: "ChainX Layer 2", raise: "$8M", roi: "22x", type: "Investment" },
    { name: "NFT Market Z", raise: "$25M", roi: "10x", type: "Advisory" },
    { name: "Metaverse Y", raise: "$5M", roi: "100x", type: "Incubation" },
    { name: "GameFi Token", raise: "$2M", roi: "55x", type: "Investment" },
];
                    ...
                    {[...projects, ...projects, ...projects].map((p, i) => (
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <div className="text-text-muted text-xs uppercase tracking-wider mb-1">Raised</div>
                                    <div className="text-xl font-mono text-white">{p.raise}</div>
                                </div>
                                <div>
                                    <div className="text-text-muted text-xs uppercase tracking-wider mb-1">ROI (ATH)</div>
